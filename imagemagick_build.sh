...
curl -L -o imagemagick.tar.gz "https://github.com/BigGreenCompany/receipt-ai/releases/download/imagemagick-7.1.1-46-heroku24/ImageMagick-heroku24-7.1.1-46.tar.gz"
